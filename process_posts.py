...
def remove_scripts(post_contents: str) -> str:
    return re.sub(r"<script.*?</script>", "", post_contents, flags=re.DOTALL)


def strip_links(post_contents: str) -> str:
...
def get_date(post_contents: str, subdir: str) -> str:
...
def get_title(post_contents: str, subdir: str) -> str:
...
def get_preview(post_contents: str, title: str, subdir: str) -> str:
...
def process_post(subdir: str) -> dict[str, str]:
    print("Processing " + subdir)
    post: dict[str, Any] = {"slug": subdir}
...
def _post_orderfn(post: dict[str, str]) -> str:
