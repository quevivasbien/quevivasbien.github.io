const e=[{slug:"fractal-friends",tags:["programming","math"],date:"2023-04-25",title:"Fractal friends",preview:"<p>Continuing with my theme of making every hobby programming project I do have some relation to the Mandelbrot set, I recently whipped up a fun little app that allows you to explore the Mandelbrot set's associated Julia sets.</p>"},{slug:"fractal-pixels",tags:["programming"],date:"2023-04",title:'"Fractal pixels" game',preview:`</h1>
<p>
