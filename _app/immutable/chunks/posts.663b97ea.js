...
discretion. The main takeaway is that interventions 2 and 3 can be significantly more effective (both in terms of cost and the resulting increase in safety) than intervention 1.</p>`},{slug:"problem-group-epistemics",tags:["econ","epistemology","math"],date:"2023-01",title:"A potential problem with group epistemics",preview:`<p>My goal here is to describe a potential problem that groups of people
