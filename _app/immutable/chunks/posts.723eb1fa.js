const e=[{slug:"third-party-roles",tags:["ai","econ"],date:"2023-03",title:"Roles for third parties in promoting safe AI innovation",preview:`<p><em>This is a summary of a paper I have been working on with Robert Trager and Nicholas Emery-Xu. Feel free to reach out for the full version.</em></p>
...
discretion. The main takeaway is that interventions 2 and 3 can be significantly more effective (both in terms of cost and the resulting increase in safety) than intervention 1.</p>`},{slug:"mandelbrot-wasm",tags:["code","math"],date:"2023-03",title:"Yet another Mandelbrot explorer",preview:`<p>I've made quite a few attempts at creating a visualizer for the Mandelbrot set. This has become something of a go-to project for me when learning a new programming language and has been a not-insignificant factor in motivating me to learn some new technologies.</p>
