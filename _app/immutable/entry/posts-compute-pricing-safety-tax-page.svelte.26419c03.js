...
versa).`),oe=l(),q=s("p"),Ce=f(`Below we summarize some insights from this model, explained in more
detail in the full paper.`),se=l(),E=s("h2"),He=f(`Importance of safety’s
...
development may be a good way to improve safety.`),ce=l(),Nt(I.$$.fragment),le=l(),P=s("h2"),De=f(`Monopolies
good for safety, competition encourages risk-taking`),pe=l(),L=s("p"),Ge=f(`When there is less competitive pressure to increase performance,
...
a modest subsidy.`),ue=l(),U=s("blockquote"),D=s("p"),Ye=f(`In general, subsidizing actors with a performance advantage is better
for safety than subsidizing performance laggards, though this is
sensitive to some assumptions.`),de=l(),C=s("p"),Ze=f(`The intuition here is that a subsidy for a performance leader further
...
unclear whether to subsidize safety-conscious actors`),be=l(),H=s("p"),tt=f(`In the case where we cannot give a single player a decisive edge, we
...
if their competitor is subsidized instead.`),ve=l(),F=s("blockquote"),G=s("p"),it=f(`If a safety-conscious actor’s competitor believes that there is
...
safety comes at the cost of spending on performance (and vice
versa).`),ze.forEach(t),oe=p(e),q=r(e,"P",{});var bt=n(q);Ce=c(bt,`Below we summarize some insights from this model, explained in more
detail in the full paper.`),bt.forEach(t),se=p(e),E=r(e,"H2",{id:!0});var vt=n(E);He=c(vt,`Importance of safety’s
...
making compute more expensive is likely to improve safety. We can
interpret this as a reframing of the idea that slowing down AI
development may be a good way to improve safety.`),xe.forEach(t),ce=p(e),jt(I.$$.fragment,e),le=p(e),P=r(e,"H2",{id:!0});var It=n(P);De=c(It,`Monopolies
good for safety, competition encourages risk-taking`),It.forEach(t),pe=p(e),L=r(e,"P",{});var Pt=n(L);Ge=c(Pt,`When there is less competitive pressure to increase performance,
actors are able to spend more on safety. Safety therefore tends to be
higher if one actor has an overwhelming competitive advantage (meaning
they are able to produce performance at a much lower cost, either
because they are more efficient or because they face a lower compute
...
actually have a negative effect on safety. It’s therefore worth
considering whom (if anyone) should be subsidized if we can only provide
a modest subsidy.`),xt.forEach(t),ue=p(e),U=r(e,"BLOCKQUOTE",{});var At=n(U);D=r(At,"P",{});var qt=n(D);Ye=c(qt,`In general, subsidizing actors with a performance advantage is better
for safety than subsidizing performance laggards, though this is
sensitive to some assumptions.`),qt.forEach(t),At.forEach(t),de=p(e),C=r(e,"P",{});var $t=n(C);Ze=c($t,`The intuition here is that a subsidy for a performance leader further
reduces the competitive pressure on that actor, while a subsidy for a
performance laggard just brings them into closer competition with the
leader(s).`),$t.forEach(t),ye=p(e),T=r(e,"H2",{id:!0});var St=n(T);et=c(St,`Often
unclear whether to subsidize safety-conscious actors`),St.forEach(t),be=p(e),H=r(e,"P",{});var Lt=n(H);tt=c(Lt,`In the case where we cannot give a single player a decisive edge, we
might think that helping safety-conscious actors is a good idea. It
turns out that this is not always the case; the effect of such an
intervention depends on a number of factors, including what exactly is
meant by being “safety-conscious.” The basic concern here is that
...
competitor(s) to take on more risk in order to catch up, while the
safety-conscious actor will not take on as much risk to be competitive
if their competitor is subsidized instead.`),Lt.forEach(t),ve=p(e),F=r(e,"BLOCKQUOTE",{});var Ot=n(F);G=r(Ot,"P",{});var Bt=n(G);it=c(Bt,`If a safety-conscious actor’s competitor believes that there is
near-zero risk of disaster, it is typically better to subsidize the
safety-conscious actor. However, the right course of action is unclear
...
illustration of this claim.`),Ae.forEach(t),we=p(e),jt(z.$$.fragment,e),ke=p(e),k=r(e,"H2",{class:!0,id:!0});var Ct=n(k);rt=c(Ct,`Some policy
implications`),Ct.forEach(t),_e=p(e),M=r(e,"P",{});var Ht=n(M);nt=c(Ht,`There is still a lot of work to do with this sort of model, but we
can already give some suggestions relevant for policy.`),Ht.forEach(t),Ee=p(e),m=r(e,"UL",{});var Q=n(m);J=r(Q,"LI",{});var Ft=n(J);V=r(Ft,"P",{});var Mt=n(V);ft=c(Mt,`Increasing compute prices (or otherwise making AI progress more
difficult) may be helpful if we are worried about safety keeping pace
...
(e.g., giving a discount to actors who pass a safety audit) is probably
much better – we are currently looking more into this sort of
intervention.`),Xt.forEach(t),this.h()},h(){h(A,"href","https://arxiv.org/abs/2302.11436"),h(E,"id","importance-of-safetys-returns-to-scale"),h(v,"href","#fig:claim-theta-regimes"),h(v,"data-reference-type","ref"),h(v,"data-reference","fig:claim-theta-regimes"),h(P,"id","monopolies-good-for-safety-competition-encourages-risk-taking"),h(T,"id","often-unclear-whether-to-subsidize-safety-conscious-actors"),h(w,"href","#fig:claim-A-beliefs-diff"),h(w,"data-reference-type","ref"),h(w,"data-reference","fig:claim-A-beliefs-diff"),h(k,"class","unnumbered"),h(k,"id","some-policy-implications")},m(e,a){o(e,d,a),i(d,qe),o(e,ie,a),o(e,x,a),i(x,_),i(_,$e),i(_,A),i(A,Se),i(_,Le),o(e,ae,a),o(e,y,a),i(y,Oe),i(y,R),i(R,Be),i(y,Ue),o(e,oe,a),o(e,q,a),i(q,Ce),o(e,se,a),o(e,E,a),i(E,He),o(e,re,a),o(e,$,a),i($,Fe),o(e,ne,a),o(e,S,a),i(S,u),i(u,Me),i(u,X),i(X,We),i(u,Ke),i(u,N),i(N,Qe),i(u,Re),o(e,fe,a),o(e,b,a),i(b,Xe),i(b,v),i(v,Ne),i(b,je),o(e,ce,a),Dt(I,e,a),o(e,le,a),o(e,P,a),i(P,De),o(e,pe,a),o(e,L,a),i(L,Ge),o(e,he,a),o(e,O,a),i(O,j),i(j,Je),o(e,me,a),o(e,B,a),i(B,Ve),o(e,ue,a),o(e,U,a),i(U,D),i(D,Ye),o(e,de,a),o(e,C,a),i(C,Ze),o(e,ye,a),o(e,T,a),i(T,et),o(e,be,a),o(e,H,a),i(H,tt),o(e,ve,a),o(e,F,a),i(F,G),i(G,it),o(e,ge,a),o(e,g,a),i(g,at),i(g,w),i(w,ot),i(g,st),o(e,we,a),Dt(z,e,a),o(e,ke,a),o(e,k,a),i(k,rt),o(e,_e,a),o(e,M,a),i(M,nt),o(e,Ee,a),o(e,m,a),i(m,J),i(J,V),i(V,ft),i(m,ct),i(m,Y),i(Y,Z),i(Z,lt),i(m,pt),i(m,ee),i(ee,te),i(te,ht),o(e,Ie,a),o(e,W,a),i(W,mt),Pe=!0},p:ai,i(e){Pe||(Gt(I.$$.fragment,e),Gt(z.$$.fragment,e),Pe=!0)},o(e){Jt(I.$$.fragment,e),Jt(z.$$.fragment,e),Pe=!1},d(e){e&&t(d),e&&t(ie),e&&t(x),e&&t(ae),e&&t(y),e&&t(oe),e&&t(q),e&&t(se),e&&t(E),e&&t(re),e&&t($),e&&t(ne),e&&t(S),e&&t(fe),e&&t(b),e&&t(ce),Vt(I,e),e&&t(le),e&&t(P),e&&t(pe),e&&t(L),e&&t(he),e&&t(O),e&&t(me),e&&t(B),e&&t(ue),e&&t(U),e&&t(de),e&&t(C),e&&t(ye),e&&t(T),e&&t(be),e&&t(H),e&&t(ve),e&&t(F),e&&t(ge),e&&t(g),e&&t(we),Vt(z,e),e&&t(ke),e&&t(k),e&&t(_e),e&&t(M),e&&t(Ee),e&&t(m),e&&t(Ie),e&&t(W)}}}class ci extends ei{constructor(d){super(),ti(this,d,null,ri,ii,{})}}export{ci as default};
