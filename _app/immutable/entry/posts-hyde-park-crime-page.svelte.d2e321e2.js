import{S as Ie,i as Pe,s as ge,k as h,q as s,a as o,y as x,l as p,m as d,r as i,h as t,c as l,z as H,n as fe,b as r,H as n,A as R,C as Te,g as U,d as q,B as C}from"../chunks/index.d8bf866d.js";import{F as M}from"../chunks/Figure.5b178d37.js";const ke=""+new URL("../assets/ucpd_map2.9aa7f174.png",import.meta.url).href,Se=""+new URL("../assets/hyde_park_daily_incidents.653580c4.png",import.meta.url).href,Ee=""+new URL("../assets/thefts_robberies_by_hour.6b334c62.png",import.meta.url).href,xe=""+new URL("../assets/violent_crimes_hourly.2554958e.png",import.meta.url).href,He=""+new URL("../assets/hyde_park_hourly_incidents.21f417b7.png",import.meta.url).href;function Re($e){let u,X,z,c,Z,v,ee,te,A,m,L,f,ae,$,re,ne,I,se,ie,G,P,oe,O,j,B,g,le,D,y,F,w,J,T,he,Y,k,pe,K,_,N,b,Q,S,de,V;return m=new M({props:{src:ke}}),y=new M({props:{src:Se}}),w=new M({props:{src:He}}),_=new M({props:{src:Ee}}),b=new M({props:{src:xe}}),{c(){u=h("h1"),X=s("Hyde Park crime map"),z=o(),c=h("p"),Z=s("The University of Chicago Police Department has "),v=h("a"),ee=s("a site"),te=s(` where you can see the various incidents reported to the department each day.
    ...
    do that.`),A=o(),x(m.$$.fragment),L=o(),f=h("p"),ae=s(`To create this, I used Python's Requests and Beautiful Soup libraries to
    ...
    `),I=h("a"),se=s("OpenStreetMap"),ie=s(" view of Hyde Park."),G=o(),P=h("p"),oe=s(`You can see that most incidents are concentrated at the University of
    ...
    from the data I collected.`),this.h()},l(e){u=p(e,"H1",{});var a=d(u);X=i(a,"Hyde Park crime map"),a.forEach(t),z=l(e),c=p(e,"P",{});var W=d(c);Z=i(W,"The University of Chicago Police Department has "),v=p(W,"A",{href:!0});var ue=d(v);ee=i(ue,"a site"),ue.forEach(t),te=i(W,` where you can see the various incidents reported to the department each day.
    I wanted to be able to visualize where these incidents were concentrated, and
    since each event is labeled with an address, I figured I could create a map to
    do that.`),W.forEach(t),A=l(e),H(m.$$.fragment,e),L=l(e),f=p(e,"P",{});var E=d(f);ae=i(E,`To create this, I used Python's Requests and Beautiful Soup libraries to
    scrape the incident report archives, gathering all incidents from 1
    ...
    addresses.) The final product is just a Matplotlib scatterplot of those
    coordinates overlaid on an
    `),I=p(E,"A",{href:!0});var me=d(I);se=i(me,"OpenStreetMap"),me.forEach(t),ie=i(E," view of Hyde Park."),E.forEach(t),G=l(e),P=p(e,"P",{});var ye=d(P);oe=i(ye,`You can see that most incidents are concentrated at the University of
    Chicago hospital, with a few on the university campus, and most of the rest
    around the main stores and other businesses in the area. There are, of
    ...
    Hyde Park. I'm sure there are many more insights that could be extracted
    from the data I collected.`),ve.forEach(t),this.h()},h(){fe(v,"href","https://incidentreports.uchicago.edu/incidentReportArchive.php"),fe($,"href","https://pypi.org/project/geocoder/"),fe(I,"href","https://www.openstreetmap.org/")},m(e,a){r(e,u,a),n(u,X),r(e,z,a),r(e,c,a),n(c,Z),n(c,v),n(v,ee),n(c,te),r(e,A,a),R(m,e,a),r(e,L,a),r(e,f,a),n(f,ae),n(f,$),n($,re),n(f,ne),n(f,I),n(I,se),n(f,ie),r(e,G,a),r(e,P,a),n(P,oe),r(e,O,a),r(e,j,a),r(e,B,a),r(e,g,a),n(g,le),r(e,D,a),R(y,e,a),r(e,F,a),R(w,e,a),r(e,J,a),r(e,T,a),n(T,he),r(e,Y,a),r(e,k,a),n(k,pe),r(e,K,a),R(_,e,a),r(e,N,a),R(b,e,a),r(e,Q,a),r(e,S,a),n(S,de),V=!0},p:Te,i(e){V||(U(m.$$.fragment,e),U(y.$$.fragment,e),U(w.$$.fragment,e),U(_.$$.fragment,e),U(b.$$.fragment,e),V=!0)},o(e){q(m.$$.fragment,e),q(y.$$.fragment,e),q(w.$$.fragment,e),q(_.$$.fragment,e),q(b.$$.fragment,e),V=!1},d(e){e&&t(u),e&&t(z),e&&t(c),e&&t(A),C(m,e),e&&t(L),e&&t(f),e&&t(G),e&&t(P),e&&t(O),e&&t(j),e&&t(B),e&&t(g),e&&t(D),C(y,e),e&&t(F),C(w,e),e&&t(J),e&&t(T),e&&t(Y),e&&t(k),e&&t(K),C(_,e),e&&t(N),C(b,e),e&&t(Q),e&&t(S)}}}class Ce extends Ie{constructor(u){super(),Pe(this,u,null,Re,ge,{})}}export{Ce as default};
