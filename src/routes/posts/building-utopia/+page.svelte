...
<p>
    ...
    largely based on <a href="{base}/posts/deeper-with-axiom-m/"
        >my idea of desire satisfaction as a reasonable basis for moral thinking</a
    >, as well as the sort of thinking that underlies the traditional economic
...
<p>
    <em
        >(Note: unless you like mathematizing everything like I do, you might
        want to just skim this section and get on to the content below.)</em
    >
</p>

<p>
    As I have written before, a good starting point for this sort of thinking is
    ...
    individuals are assumed to have a set of <a
        href="https://quevivasbien.wordpress.com/2019/07/12/formalizing-the-idea-of-preference/"
        >well-behaved preferences</a
    > that can be assumed to be modeled by a “utility function” that assigns a state
...
<p>
    It is one thing to analyze the ways, in line with my proposed framework,
    ...
    that <a href="{base}/posts/very-rough-moral-theory/"
        >social groups should act in such a way as to achieve the “desires”
    ...
    <a
        href="{base}/posts/deeper-with-axiom-m/"
        >I have tried to address some of those problems</a
    >
    ...
    <a href="https://en.wikipedia.org/wiki/Social_choice_theory"
        >really quite interesting</a
    >), but the fact remains that the way in which individual preferences/states
    ...
    <strong
        >The rest of this essay is an exploration of what it is possible to say
        about the collective desires of all of humanity and what I think we
        ought to do to maximize our chances of fulfilling those desires.</strong
    >
</p>
...
<p>
    As detailed above, it is hard to say in a rigorous and exact fashion what
...
<ul>
    <li>Humanity wants to survive.</li>
    <li>
        Humanity wants to provide pleasurable and meaningful lives to its
        constituent persons.
    </li>
    <li>
        Humanity wants to increase in knowledge and understanding about how the
        physical world works and apply that knowledge to technological
        development.
    </li>
    <li>
        Humanity wants to be wealthier (in the sense of having the capability to
    ...
    <li>
        Humanity wants to produce monuments to its culture (literal monuments,
        works of art, bodies of literature, music, etc.).
    </li>
    <li>
        Humanity wants to provide certain rights to, and enforce some sort of
        social justice among, its constituent persons. (This one is a somewhat
        more recent desire, manifest with the rise of <a
            href="https://en.wikipedia.org/wiki/Liberalism"
            >liberal political thinking</a
        > since the Enlightenment a few centuries back. This way of thinking is of
        course not universal, but does hold great sway in many parts of the modern
        world.)
    </li>
    <li>
        Humanity wants to be in line with a higher power. (Although this
...
<p>
    This list is not intended to be exhaustive, but I think it provides a
...
<p>
    I want to paint a mental image of what <em>could</em> be possible, what human
...
<p>
    First, to satisfy the desire to survive, we need to still be around. This
...
<p>
    Given that humankind is still extant in our hypothetical future, the things
    ...
    future, <a href="https://en.wikipedia.org/wiki/Post-scarcity_economy"
        >exist in a post-scarcity economy</a
    >. Individuals living in such a situation would be principally concerned not
...
<p>
    I am of the persuasion that automation technology can potentially progress
...
<p>
    Medical technology would have reached the point where disease had been
...
<p>
    With practically unlimited resources, overpopulation would not be too much
...
<p>
    Various human rights would be guaranteed to all people (probably something
    like the <a href="https://www.un.org/en/universal-declaration-human-rights/"
        >UN’s Universal Declaration of Human Rights</a
    >, but adapted to the specific concerns of the time). In general,
...
<p>
    Talking about possible utopian states does little good without a plan to get
    ...
    unintentionally prescient in coining the name “<a
        href="https://en.wikipedia.org/wiki/Utopia_(book)">Utopia</a
    >” after the Greek for “no place.” I can identity a few ways in which we may
...
<p>
    Humanity faces several existential threats that could lead to its extinction
    or at least to its irreversible dwindling. Some thinkers have suggested that <a
        href="https://web.archive.org/web/20200616084146/https://slatestarcodex.com/2020/04/01/book-review-the-precipice/"
        >we are currently facing a critical period</a
    >
    ...
    since the Cold War,
    <a href="https://samharris.org/podcasts/210-logic-doomsday/"
        >this threat is perhaps more pressing than ever before and deserves our
        attention</a
    >. Man-made pathogens could also prove much more dangerous than naturally
    ...
    some
    <a href="https://en.wikipedia.org/wiki/Human_Compatible"
        >very smart people quite concerned</a
    >, is the potential for superintelligent artificial intelligences to go
...
<p>
    I should note that none of the above-listed threats are guaranteed to
...
<p>
    Even if we don’t go extinct, it is still possible that we might fail to
    ...
    already seems to be the case that <a
        href="https://conversationswithtyler.com/episodes/peter-thiel/"
        >technological progress has been slowing down in the past few decades</a
    >, and
    <a
        href="https://www.ted.com/talks/robert_gordon_the_death_of_innovation_the_end_of_growth"
        >future growth may be much more difficult than it has been</a
    > since the start of the industrial revolution. We should look carefully into
...
<p>
    A worrisome trend I have seen over the past couple of decades, fomented
...
<p>
    I don’t want to be misunderstood: I am strongly in favor of technological
...
<p>
    Even if we manage to dodge all of the obstacles mentioned so far, we may
...
<p>
    Wealth inequality has received a lot of attention in the U.S. in recent
    ...
    the <a href="https://en.wikipedia.org/wiki/Belt_and_Road_Initiative"
        >actions of nations like China</a
    >
    ...
    <a
        href="https://wol.iza.org/articles/who-owns-the-robots-rules-the-world/long"
        >whoever owns the machines will find themselves rolling in the dough</a
    >. It is a mistake to think that anyone’s job is immune to automation:
    <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3482150"
        >even highly-educated workers could find themselves replaced</a
    >
...
<p>
    Humanity’s future lies along a path promising both great rewards and
...
<p>
    If you enjoyed this essay and want to think more carefully about these
...
<ul>
    <li>
        <a href="https://80000hours.org/">80,000 hours</a> for well-thought-out advice
        about how to have an impactful career. Many of their focus areas involve
        issues touched upon here.
    </li>
    <li>
        Works of fiction like Iain Banks’ <a
            href="https://www.goodreads.com/series/49118-culture"
            >Culture series</a
        > to help you get excited about what our collective future could look like.
    </li>
    <li>
        Podcasts to help you be better-informed about social and economic issues
        that contribute to or detract from our collective flourishing — here are
        some of my favorites: <a href="https://conversationswithtyler.com/"
            >Conversations with Tyler</a
        >, <a href="https://www.econtalk.org/">EconTalk</a>, the
        <a href="https://80000hours.org/podcast/">80,000 hours podcast</a>.
    </li>
    <li>
        Technical books to help structure your thinking about our aggregate
        well-being — here’s one I’ve been reading recently (free as of July
        2020): <a
            href="https://link.springer.com/book/10.1007/978-3-319-50319-6"
            >Economics as Applied Ethics</a
        >.
    </li>
</ul>
