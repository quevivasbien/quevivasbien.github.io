...
<!-- TAGS: ethics -->
<!-- DATE: 2020-06 -->
<h1>A [very rough] moral theory of everything</h1>

<p>I’ve <a href="{base}/posts/deeper-with-axiom-m">written before</a> about what I think is a good
    ...
    that <a
        href="{base}/posts/relationship-with-ea">focusing
...
<p>to think reasonably about morality on the group level. Many of my previous thoughts about the
    individualized <a href="{base}/posts/deeper-with-axiom-m">Axiom M</a> still apply here,
