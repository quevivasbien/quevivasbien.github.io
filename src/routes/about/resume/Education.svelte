...
<div class="p-4 bg-white rounded-lg space-y-4">
    ...
    <Position title="BS in Computational Mathematics" org="University of Utah" dates="2018 - 2020">
        <ul>
            <li>Graduated with 4.0 GPA</li>
            <li>Coursework included physics, calculus, numerical analysis, computer science, probability, and statistics</li>
        </ul>
    </Position>
</div>